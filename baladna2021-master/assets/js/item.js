...
export class Item {
    ...
    constructor(DOM_el) {
        ...
        this.DOM.image = this.DOM.el.querySelector('.item_img');
        this.DOM.title = this.DOM.el.querySelector('.item_caption-title');
        this.DOM.description = this.DOM.el.querySelector('.item_caption-description');
